<template>
    <div>
        ...
        <div class="row">
                                                ...
                                                <div class="site-card-rightside" >
                                                    ...
                                                    <div class="camera-list-videobox">
                                                        ...
                                                        <div class="camera-box timeline-clip-box cp"  @click="isHistoryMode=true; loadVideoStream(clip, clip.camera_id, clip.start_timestamp);">
                                                            <img :src="clip.preview_image?.image_small_path_url ? clip.preview_image?.image_small_path_url : '/img/empty_img_small.jpg'" class="img-fluid" alt="camera img"/>
                                                        ...
                                                        <div>
                                                            ...
                                                            <button v-if="clip.status == 1"  @click="downloadsClipsAsZip(clip.job_id)" class="mt-2 ionic-btn-block status-active cp">Download</button>
            ...
            <div :class="isCollapsedIframe ? 'col-xl-8 col-lg-7 col-md-6 collaps-fream-column' : 'col-xl-12 col-lg-12 col-md-12 collaps-fream-column video-collapsfull-view' " @mouseenter="mouseentered=true" @mouseleave="mouseentered=false" >
...
onMounted(async () => {
    ...
    //     const url = 'https://api.c027.eagleeyenetworks.com/api/v3.0/downloads/0948c366-44f2-4121-b90c-38fa23659a8b:download';
...
async function downloadsClipsAsZip(clipId){
    const url = `${siteStore.siteCamerasLiveFeed.een_base_url}/api/v3.0/downloads/${clipId}:download`
    const options = {
      method: 'GET',
      headers: {
