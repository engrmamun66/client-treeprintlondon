...
Redactor.add('plugin', 'variable', {
    ...
    start() {
        ...
        let button = { title: this.lang.get('variable.title'), icon: this.defaults.icon, command: 'variable.popup' };
    ...
    popup(e, button) {
        ...
        let dropdown = this.app.create('dropdown', 'variable', { items: buttonsObj });
    ...
    add(e, button, name) {
        ...
        let variable = this.opts.get('variable.start') + name + this.opts.get('variable.end');
